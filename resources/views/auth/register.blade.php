            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-center d-block">
                        <img class="img-thumbnail" width="150" height="150" src="{{ asset('img/logo.png') }}">
                    </p>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kontak" type="text" class="form-control @error('kontak') is-invalid @enderror" name="kontak" value="{{ old('kontak') }}" pattern="^08[\d]{10,14}" required autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" required autocomplete="off">{{ old('alamat') }}</textarea>
