...
@section('admin.content')
    <div class="col-md-8" x-data="dataProduk()">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route(Route::currentRouteName()) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="form-group mb-2">
                        <label for="produk_nama" class="sr-only">{{ __('Nama') }}</label>
                        <input id="produk_nama" type="text" name="produk_nama" class="form-control form-control-lg @error('produk_nama') is-invalid @enderror" placeholder="{{ __('Nama Produk') }}" required value="{{ old('produk_nama') }}">
                        @error('produk_nama')
                    ...
                    <div class="form-group mb-2 row align-items-center">
                        <div class="col-md-6 mb-2 col-12">
                            ...
                            <input id="produk_stok" type="number" class="form-control @error('produk_stok') is-invalid @enderror" required min="0" name="produk_stok" value="{{ old('produk_stok') ?? 0 }}">
                        </div>
                        <div class="col-md-6 col-12">
                            <label for="produk_disembunyikan">{{ __('Visibilitas Produk') }}</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1"  name="produk_disembunyikan" id="produk_disembunyikan">
                    ...
                    <div class="form-group mb-2 row">
                        <div class="col-md-6 mb-2 col-12">
                            ...
                            <input id="produk_harga" type="number" class="form-control @error('produk_harga') is-invalid @enderror" required min="0" name="produk_harga" value="{{ old('produk_harga') ?? 0 }}">
                        </div>
                        <div class="col-md-6 col-12">
                            <label for="produk_diskon">{{ __('Diskon') }}</label>
                            <input id="produk_diskon" type="number" class="form-control @error('produk_diskon') is-invalid @enderror" required min="0" name="produk_diskon" value="{{ old('produk_diskon') ?? 0 }}">
                        </div>
                    </div>
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <textarea class="form-control @error('produk_deskripsi') is-invalid @enderror" name="produk_deskripsi" id="produk_deskripsi">{{ old('produk_deskripsi') }}</textarea>
